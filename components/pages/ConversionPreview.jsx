...
export default function ConversionPreview() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white text-slate-900">
      <div className="border-b border-amber-200 bg-amber-50 px-4 py-2 text-center text-xs font-semibold text-amber-950">Private conversion preview · the current live landing page remains unchanged</div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-cyan-50 via-white to-blue-100 px-4 py-14 sm:py-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <h1 className="mx-auto mt-4 max-w-4xl text-balance text-4xl font-black leading-[1.08] text-slate-900 sm:text-5xl lg:text-6xl">Trademark Registration for Your Business Name, Logo or Slogan</h1>
          <p className="mx-auto mt-6 max-w-3xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">Complete a guided questionnaire and our filing team will prepare your application for review. Approve the details, then follow documents and updates from your secure customer account.</p>
      ...
      <section className="border-b border-slate-200 bg-white px-4 py-7" aria-label="Service benefits">
      ...
      <section className="px-4 py-16 sm:py-20" id="packages">
        <div className="mx-auto max-w-6xl">
      ...
      <section className="bg-[#062b47] px-4 py-16 text-white sm:py-20">
      ...
      <section className="bg-gradient-to-r from-[#07395c] to-[#087fd3] px-4 py-14 text-white sm:py-16">
