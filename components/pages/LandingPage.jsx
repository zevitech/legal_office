    ...
    <>
      ...
      <section data-customizer-old-section="hero" className="relative overflow-hidden bg-gradient-to-br from-[#eefbff] via-white to-[#e8f2ff]">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-14 text-center sm:py-20 lg:py-24">
          ...
          <div className="mx-auto mt-8 grid w-full max-w-4xl grid-cols-1 gap-3 text-sm font-semibold text-slate-700 sm:grid-cols-3">{["Complete the application form", "We prepare your application", "Filed with the USPTO"].map((item, index) => <span key={item} className="inline-flex min-w-0 items-center justify-center gap-2 text-center"><span aria-hidden="true" className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-blue-100 text-xs font-bold text-[#026daf]">{index + 1}</span><span className="min-w-0">{item}</span></span>)}</div>
        </div>
      </section>
