    ...
    <>
      ...
      <section data-customizer-old-section="hero" className="relative overflow-hidden bg-gradient-to-br from-[#eefbff] via-white to-[#e8f2ff]">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-14 text-center sm:py-20 lg:py-24">
          ...
          <div className="mx-auto mt-8 flex max-w-3xl flex-wrap justify-center gap-x-7 gap-y-3 text-sm font-semibold text-slate-700">{["Careful filing preparation", "Secure online account", "Guided start to filing"].map((item) => <span key={item} className="inline-flex items-center gap-2"><HiCheck className="text-emerald-600" aria-hidden="true" />{item}</span>)}</div>
        </div>
      </section>
