      ...
      <div className="mx-auto grid w-full max-w-7xl items-stretch gap-5 lg:grid-cols-[.55fr_1.45fr]">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <article className="grid min-h-24 grid-cols-[auto_1fr] items-center gap-4 rounded-2xl border border-cyan-100 bg-white p-4 shadow-sm">
            ...
            <div className="inline-flex justify-self-end text-slate-950" aria-label="Nike swoosh trademark logo">
              <svg viewBox="135.5 340 1060 377.77" className="h-10 w-32" role="img" aria-hidden="true">
                ...
                <text x="1110" y="385" fill="currentColor" fontSize="58" fontWeight="700">™</text>
              </svg>
            </div>
          </article>
