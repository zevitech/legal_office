...
const ClientSection = () => {
  return (
    <section className="border-y border-slate-200 bg-gradient-to-r from-slate-50 via-white to-blue-50 px-4 py-9">
      <div className="mx-auto grid max-w-5xl items-center gap-7 lg:grid-cols-[.8fr_1.2fr]">
        <div className="text-center lg:text-left">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            See common ways businesses display the ™ symbol with different types of marks.
          </p>
        </div>

        <div className="grid gap-3 sm:grid-cols-3">
          <article className="flex min-h-32 flex-col justify-between rounded-2xl border border-blue-100 bg-white p-4 shadow-sm">
          ...
          <article className="flex min-h-32 flex-col justify-between rounded-2xl border border-cyan-100 bg-white p-4 shadow-sm">
