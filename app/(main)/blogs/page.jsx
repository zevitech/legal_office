...
export default async function BlogsPage() {
  ...
  if (blogs.length === 0) {
    ...
    return <><Header /><main className="bg-slate-50">
      <section className="bg-gradient-to-br from-[#063f70] via-[#075A96] to-[#027DD6] px-5 py-28 text-center text-white"><div className="mx-auto max-w-4xl"><p className="font-semibold uppercase tracking-[0.18em] text-blue-100">Trademark resources</p><h1 className="mt-4 text-4xl font-bold leading-tight md:text-5xl">Trademark Filing News and Practical Guides</h1><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-blue-50">Use our current U.S. trademark resources to prepare for registration, understand filing costs and make a more informed next move.</p><Link href="/trademark-registration" className="mt-8 inline-flex min-h-14 items-center rounded-lg bg-white px-8 py-4 font-semibold text-[#075A96]">Compare trademark registration plans</Link></div></section>
