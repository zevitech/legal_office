...
export const metadata = { title: "Privacy Policy | Legal Trademark Office" };
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy">
      ...
      <section><h2 className="text-xl font-semibold text-slate-900">Security and retention</h2><p>Card details are tokenized by our payment provider and are not stored by this website. Other records are retained only as long as reasonably necessary for service, legal, security and accounting purposes.</p></section>
